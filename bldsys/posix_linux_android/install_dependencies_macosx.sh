...
if curl -o "${MY_DIR}/build-tools_r29.0.3-macosx.zip" --create-dirs -L https://dl.google.com/android/repository/build-tools_r29.0.3-macosx.zip; then
...
if curl -o "${MY_DIR}/platform-24_r02.zip" --create-dirs -L https://dl.google.com/android/repository/platform-24_r02.zip; then
...
if curl -o "${MY_DIR}/platform-tools_r29.0.6-darwin.zip" --create-dirs -L https://dl.google.com/android/repository/platform-tools_r29.0.6-darwin.zip; then
