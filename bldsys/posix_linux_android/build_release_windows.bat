...
call "%MY_DIR%/android-ndk-r14b/ndk-build.cmd" APP_DEBUG:=false NDK_PROJECT_PATH:=null NDK_OUT:=obj/release NDK_LIBS_OUT:=jni/release/libs NDK_APPLICATION_MK:=Application.mk APP_BUILD_SCRIPT:=build.mk
...
"%MY_DIR%/android-10/aapt.exe" package -f -0 apk -M "%MY_DIR%/AndroidManifest.xml" -S "%MY_DIR%/res" -I "%MY_DIR%/android-7.0/android.jar" -F "%MY_DIR%/bin/Android.Packaging-release-unaligned.apk" "%MY_DIR%/release/jni"    
