...
"%MY_DIR%/android-sdk/build-tools/29.0.3/aapt.exe" package -f -0 apk -M "%MY_DIR%/AndroidManifest.xml" -S "%MY_DIR%/res" -I "%MY_DIR%/android-sdk/platforms/android-24/android.jar" -F "%MY_DIR%/bin/Android.Packaging-release-unaligned.apk" "%MY_DIR%/libs/release"    
...
java.exe -jar "%MY_DIR%/android-sdk/build-tools/29.0.3/lib/apksigner.jar" sign -v --ks "%MY_DIR%/debug.keystore" --ks-pass pass:android --ks-key-alias androiddebugkey "%MY_DIR%/bin/Android.Packaging-release.apk"
