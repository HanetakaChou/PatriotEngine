...
OUT_BINS="libpt_mcrt.so libpt_tbbmalloc.so libpt_irml.so libpt_tbb.so libpt_gfx_wsi_window_x11.so pt_launcher_wsi_window_x11 libpt_gfx_wsi_bitmap.so pt_gfx_malloc_test pt_general_acyclic_graphs_of_tasks"
