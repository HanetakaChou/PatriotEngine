...
static pt_wsi_app_ref PT_PTR launcher_app_init(ANativeActivity *native_activity, void *saved_state, size_t saved_state_size, pt_gfx_connection_ref gfx_connection);
