...
参考google提供的官方文档[Building Open Source Projects Using Standalone Toolchains](https://developer.android.com/ndk/guides/standalone_toolchain#building_open_source_projects_using_standalone_toolchains)，我们基于bionic(-ndk-r11c)重新编译了PatriotEngine所依赖的所有第三方库（[X11](/ThirdParty/PosixLinuxX11/Bionic-Build/X11-README.md)、[Mesa-Vulkan-Drivers](/ThirdParty/PosixLinuxX11/Bionic-Build/Mesa-README.md)、[Vulkan-Loader](/ThirdParty/PosixLinuxX11/Bionic-Build/Vulkan-README.md)等)  
