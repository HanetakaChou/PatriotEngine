...
#define __TBB_TASK_BASE_ACCESS private
    ...
    private:
        ...
        char _leading_padding[internal::NFS_MaxLineSize - 2 * sizeof(uintptr_t) - sizeof(void *) - sizeof(internal::context_list_node_t) - sizeof(__itt_caller)
#if __TBB_FP_CONTEXT
    ...
    public:
        ...
        task_group_context(kind_type relation_with_parent = bound,
            ...
            : my_kind(relation_with_parent), my_version_and_traits(3 | t), my_name(internal::CUSTOM_CTX)
        {
            init();
        }
        ...
        task_group_context(internal::string_index name)
            : my_kind(bound), my_version_and_traits(3 | default_traits), my_name(name)
        {
            init();
        }
    ...
    public:
        ...
        {
#if __TBB_PREVIEW_CRITICAL_TASKS
            __TBB_ASSERT(p == priority_low || p == priority_normal || p == priority_high || p == internal::priority_critical, "Invalid priority level value");
#else
