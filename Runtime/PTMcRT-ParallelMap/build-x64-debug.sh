...
chrpath -r '$ORIGIN' obj/local/x86_64/PTMcRT-ParallelMap.bundle

# mkdir the out dir if necessary
mkdir -p ../../Binary/PosixLinuxX11/x64/Debug/

# copy the unstriped pie to out dir
rm -rf ../../Binary/PosixLinuxX11/x64/Debug/PTMcRT-ParallelMap.bundle
cp -f obj/local/x86_64/PTMcRT-ParallelMap.bundle ../../Binary/PosixLinuxX11/x64/Debug/
...
# gdbserver :27077 ./PTMcRT-ParallelMap.bundle
./gdbserver :27077 ./PTMcRT-ParallelMap.bundle ### //either gdbserver from ndk or your linux distribution is OK
