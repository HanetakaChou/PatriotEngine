...
${OBJECTDIR}/_ext/a77151f3/PTSMemory.o: ../../../Private/McRT/PTSMemory.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DPTMCRTAPI=PTEXPORT -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a77151f3/PTSMemory.o ../../../Private/McRT/PTSMemory.cpp

${OBJECTDIR}/_ext/a77151f3/PTSMemoryAllocator.o: ../../../Private/McRT/PTSMemoryAllocator.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a77151f3
	${RM} "$@.d"
	$(COMPILE.cc) -g -DPTMCRTAPI=PTEXPORT -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a77151f3/PTSMemoryAllocator.o ../../../Private/McRT/PTSMemoryAllocator.cpp

${OBJECTDIR}/_ext/a77151f3/PTSTaskSchedulerImpl.o: ../../../Private/McRT/PTSTaskSchedulerImpl.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a77151f3
	${RM} "$@.d"
	$(COMPILE.cc) -g -DPTMCRTAPI=PTEXPORT -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a77151f3/PTSTaskSchedulerImpl.o ../../../Private/McRT/PTSTaskSchedulerImpl.cpp
