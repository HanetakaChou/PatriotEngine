...
unsigned __stdcall RenderMain(void *pVoid)
{
	...
	g_Scene_Geometry_Grass.Init("Terrain_Displacement.dds");
	...
	GLuint hTexture_Terrain_Displacement = ::glexCreateDDSTextureFromFile("Terrain_Displacement.dds");
...
//Dispatch(16, 16, 1) 512×512->16×16
...
void main()
{
	...
	WaterTileData.m_WaterToWorld.r[1].w = 5.5f;
	...
	while (true)
	{
		...
		//CPU Update
		{
			...
			//Water
			WaterTileData.m_UVAnimated.x -= (fTime*0.0000000001f);
			WaterTileData.m_UVAnimated.y -= (fTime*0.0000000001f);
			WaterTileData.m_UVAnimated.z += (fTime*0.0000000001f);
			WaterTileData.m_UVAnimated.w -= (fTime*0.0000000001f);
		}
		...
		eglbResult = ::eglSwapInterval(hDisplay, 0);
