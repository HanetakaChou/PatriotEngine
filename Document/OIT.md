...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;![](https://gitee.com/YuqiaoZhang/PatriotEngine/blob/master/Document/OIT_1.png)  
    ...
    RenderPass:  
        ...
        SubPass:  
            ...
            4.CompositePass:
                ...
                0.FinalColor  //TransparentColor  +CorrectAlphaTotal*BackgroundColor->FinalColor //用硬件的AlphaBlend阶段实现Over操作  
        Dependency:
