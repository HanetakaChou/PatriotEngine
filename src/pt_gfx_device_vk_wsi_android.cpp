...
{
    PFN_vkCreateAndroidSurfaceKHR vk_create_android_surface = reinterpret_cast<PFN_vkCreateAndroidSurfaceKHR>(vkGetInstanceProcAddr(this->m_instance, "vkCreateAndroidSurfaceKHR"));
