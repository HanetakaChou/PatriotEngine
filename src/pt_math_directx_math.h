...
pt_math_simd_vec PT_VECTORCALL directx_math_x86_avx2_load_vec3(pt_math_vec3 *source);
pt_math_simd_vec PT_VECTORCALL directx_math_x86_avx_load_vec3(pt_math_vec3 *source);
pt_math_simd_vec PT_VECTORCALL directx_math_x86_sse2_load_vec3(pt_math_vec3 *source);
extern "C" pt_math_simd_vec PT_VECTORCALL directx_math_arm_neon_load_vec3(pt_math_vec3 *source);

pt_math_simd_vec PT_VECTORCALL directx_math_x86_avx2_load_vec4(pt_math_vec4 *source);
pt_math_simd_vec PT_VECTORCALL directx_math_x86_avx_load_vec4(pt_math_vec4 *source);
pt_math_simd_vec PT_VECTORCALL directx_math_x86_sse2_load_vec4(pt_math_vec4 *source);
extern "C" pt_math_simd_vec PT_VECTORCALL directx_math_arm_neon_load_vec4(pt_math_vec4 *source);
...
extern "C" void PT_VECTORCALL directx_math_arm_neon_store_vec3(pt_math_vec3 *source, pt_math_simd_vec v);
...
extern "C" void PT_VECTORCALL directx_math_arm_neon_store_vec4(pt_math_vec4 *source, pt_math_simd_vec v);

pt_math_simd_mat PT_VECTORCALL directx_math_x86_avx2_load_alignas16_mat4x4(pt_math_alignas16_mat4x4 *source);
pt_math_simd_mat PT_VECTORCALL directx_math_x86_avx_load_alignas16_mat4x4(pt_math_alignas16_mat4x4 *source);
pt_math_simd_mat PT_VECTORCALL directx_math_x86_sse2_load_alignas16_mat4x4(pt_math_alignas16_mat4x4 *source);
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_load_alignas16_mat4x4(pt_math_alignas16_mat4x4 *source);

pt_math_simd_mat PT_VECTORCALL directx_math_x86_avx2_load_mat4x4(pt_math_mat4x4 *source);
pt_math_simd_mat PT_VECTORCALL directx_math_x86_avx_load_mat4x4(pt_math_mat4x4 *source);
pt_math_simd_mat PT_VECTORCALL directx_math_x86_sse2_load_mat4x4(pt_math_mat4x4 *source);
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_load_mat4x4(pt_math_mat4x4 *source);
...
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_mat_identity();
...
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_mat_multiply(pt_math_simd_mat m1, pt_math_simd_mat m2);
...
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_mat_look_to_rh(pt_math_simd_vec eye_position, pt_math_simd_vec eye_direction, pt_math_simd_vec up_direction);
...
extern "C" pt_math_simd_mat PT_VECTORCALL directx_math_arm_neon_mat_perspective_fov_rh(float fov_angle_y, float aspect_ratio, float near_z, float far_z);
...
extern "C" void PT_VECTORCALL directx_math_arm_neon_store_alignas16_mat4x4(pt_math_alignas16_mat4x4 *destination, pt_math_simd_mat m);
...
extern "C" void PT_VECTORCALL directx_math_arm_neon_store_mat4x4(pt_math_mat4x4 *destination, pt_math_simd_mat m);
