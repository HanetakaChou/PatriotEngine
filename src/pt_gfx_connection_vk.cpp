...
inline bool gfx_connection_vk::update_framebuffer()
{
    ...
    assert(VK_NULL_HANDLE == this->m_render_pass);
    {
        VkAttachmentDescription attachments[2] = {
            ...
            {0U, this->m_malloc.format_depth(), VK_SAMPLE_COUNT_1_BIT, VK_ATTACHMENT_LOAD_OP_CLEAR, VK_ATTACHMENT_STORE_OP_DONT_CARE, VK_ATTACHMENT_LOAD_OP_DONT_CARE, VK_ATTACHMENT_STORE_OP_DONT_CARE, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_UNDEFINED}};
