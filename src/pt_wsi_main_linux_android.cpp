...
public:
	...
	void init(
		struct ANativeActivity *native_activity, void *saved_state, size_t saved_state_size,
	...
	pt_wsi_app_init_callback app_init_callback, pt_wsi_app_main_callback app_main_callback)
{
	...
	if (PT_UNLIKELY(NULL == g_wsi_linux_android_instance))
	{
		...
		g_wsi_linux_android_instance->init(
...
{
	//
	this->m_gfx_connection = pt_gfx_connection_init(
		NULL, NULL,
		cache_input_stream_init_callback, cache_input_stream_stat_size_callback, cache_input_stream_read_callback, cache_input_stream_destroy_callback,
		cache_output_stream_init_callback, cache_output_stream_write_callback, cache_output_stream_destroy_callback);
	...
	// the "app_main"
	{
		...
		app_main_argument.m_native_activity = native_activity;
		app_main_argument.m_saved_state = saved_state;
		app_main_argument.m_saved_state_size = saved_state_size;
