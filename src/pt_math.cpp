...
static pt_math_simd_mat(PT_VECTORPTR *pfn_math_mat_perspective_fov_rh)(float fov_angle_y, float aspect_ratio, float near_z, float far_z) = NULL;
...
struct math_verify_x86_cpu_support
{
    inline math_verify_x86_cpu_support()
    {
        ...
        if (math_support_avx2)
        {
            ...
            pfn_math_mat_perspective_fov_rh = directx_math_x86_avx2_mat_perspective_fov_rh;
        ...
        else if (math_support_avx)
        {
            ...
            pfn_math_mat_perspective_fov_rh = directx_math_x86_avx_mat_perspective_fov_rh;
        ...
        else
        {
            ...
            pfn_math_mat_perspective_fov_rh = directx_math_x86_sse2_mat_perspective_fov_rh;
