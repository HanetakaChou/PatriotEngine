...
bool gfx_mesh_vk::read_input_stream(class gfx_connection_base *gfx_connection_base, uint32_t mesh_index, uint32_t material_index, char const *initial_filename, gfx_input_stream_ref(PT_PTR *input_stream_init_callback)(char const *initial_filename), intptr_t(PT_PTR *input_stream_read_callback)(gfx_input_stream_ref input_stream, void *buf, size_t count), int64_t(PT_PTR *input_stream_seek_callback)(gfx_input_stream_ref input_stream, int64_t offset, int whence), void(PT_PTR *input_stream_destroy_callback)(gfx_input_stream_ref input_stream))
{
    ...
    if (!streaming_cancel)
    {
        ...
        // pass to the second stage
        {
            ...
            static_assert(sizeof(struct mesh_read_input_stream_task_data_t) <= sizeof(mcrt_task_user_data_t), "");
            struct mesh_read_input_stream_task_data_t *task_data = reinterpret_cast<struct mesh_read_input_stream_task_data_t *>(mcrt_task_get_user_data(task));
...
mcrt_task_ref gfx_mesh_vk::read_input_stream_task_execute(mcrt_task_ref self)
{
    ...
    {
        static_assert(sizeof(struct mesh_read_input_stream_task_data_t) <= sizeof(mcrt_task_user_data_t), "");
        struct mesh_read_input_stream_task_data_t *task_data = reinterpret_cast<struct mesh_read_input_stream_task_data_t *>(mcrt_task_get_user_data(self));
    ...
    {
        static_assert(sizeof(mesh_read_input_stream_task_data_t) <= sizeof(mcrt_task_user_data_t), "");
        mesh_read_input_stream_task_data_t *task_data = reinterpret_cast<mesh_read_input_stream_task_data_t *>(mcrt_task_get_user_data(self));
