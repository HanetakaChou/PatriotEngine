...
#if defined(__PT_MCRT_RTE_MEMCPY_AVX512F) /* AVX512 */
...
static __rte_always_inline void *rte_memcpy_generic(void *dst, const void *src, size_t n)
{
...
#elif defined(__PT_MCRT_RTE_MEMCPY_AVX) /* AVX */
...
#elif defined(__PT_MCRT_RTE_MEMCPY_SSSE3) /* SSSE3 */
