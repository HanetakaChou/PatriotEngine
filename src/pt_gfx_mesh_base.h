...
public:
    bool read_input_stream(class gfx_connection_base *gfx_connection, uint32_t mesh_index, uint32_t material_index, char const *initial_filename, pt_gfx_input_stream_init_callback gfx_input_stream_init_callback, pt_gfx_input_stream_read_callback gfx_input_stream_read_callback, pt_gfx_input_stream_seek_callback gfx_input_stream_seek_callback, void(PT_PTR *gfx_input_stream_destroy_callback)(pt_gfx_input_stream_ref ));
