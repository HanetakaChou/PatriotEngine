...
public:
    ...
    inline void transfer_dst_and_sampled_image_free(void *gfx_malloc_page, uint64_t offset, uint64_t size, VkDeviceMemory device_memory)
    {
        return internal_transfer_dst_and_sampled_image_free(gfx_malloc_page, offset, size, device_memory);
    }
};
