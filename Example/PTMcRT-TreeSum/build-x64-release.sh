...
chrpath -r '$ORIGIN' libs/x86_64/PTMcRT-TreeSum.bundle

# mkdir the out dir if necessary
mkdir -p ../../../Binary/PosixLinuxX11/x64/Release/

# copy the unstriped pie to out dir
rm -rf ../../Binary/PosixLinuxX11/x64/Release/PTMcRT-TreeSum.bundle
cp -f libs/x86_64/PTMcRT-TreeSum.bundle ../../Binary/PosixLinuxX11/x64/Release/
