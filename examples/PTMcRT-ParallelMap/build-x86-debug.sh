...
chrpath -r '$ORIGIN' obj/local/x86/PTMcRT-ParallelMap.bundle

# mkdir the out dir if necessary
mkdir -p ../../Binary/PosixLinuxX11/x86/Debug/

# copy the unstriped pie to out dir
rm -rf ../../Binary/PosixLinuxX11/x86/Debug/PTMcRT-ParallelMap.bundle
cp -f obj/local/x86/PTMcRT-ParallelMap.bundle ../../Binary/PosixLinuxX11/x86/Debug/
